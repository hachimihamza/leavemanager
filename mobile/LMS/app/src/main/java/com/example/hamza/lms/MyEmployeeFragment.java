...
public class MyEmployeeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_my_employee, container, false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        requestID = (String) getArguments().getString("requestID");
        type = (String) getArguments().getString("type");
        managerID = (String) getArguments().getString("managerID");
        ...
        accept = (Button) getView().findViewById(R.id.accept_request);
        accept.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                accepturl = Network.root + requestID + "/accept-request";
                StringRequest stringRequest = new StringRequest(Request
                        .Method.GET, accepturl,
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
                                //cancelRequest();
                                Toast.makeText(getActivity(), requestID
                                                + " was accepted ",
        ...
        refuse = (Button) getView().findViewById(R.id.refuse_request);
        refuse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                accepturl = Network.root + requestID + "/refuse-request";
                StringRequest stringRequest = new StringRequest(Request
                        .Method.GET, accepturl,
                        new Response.Listener<String>() {
                            @Override
    ...
    public void cancelRequest(){
        ...
        // manager
        Employee empl = new Employee(managerID);
        args.putSerializable("emp", empl);
